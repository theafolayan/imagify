 ...
 <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0 is-revealing">Find and share photos with ease</h1>
	                        <p class="hero-paragraph is-revealing">Imagify runs so your photos can fly. Really!</p>
                        <form action="{{route('login')}}" method="POST" id="loginForm">
                            @csrf
                            	<div class="hero-form field field-grouped is-revealing">
	                            <div class="control control-expanded">
	                                <input class="input" type="email" name="email" placeholder=" Email eg: john@imagify.dev">
                                </div>
                                <div class="control control-expanded">
                                    <input class="input" type="password" name="password" required autocomplete="current-password" placeholder="Password">
                                    @error('password')
	                            ...
	                            <div class="control">
	                                <a class="button button-primary button-block" href="#" onclick="document.getElementById('loginForm').submit()">Log In</a>
	                            </div>
	                        </div>
                        </form>
						</div>
